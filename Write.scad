/* 	Version 3
 ...
 (The file Letters.dxf was created with inkscape..Each letter is in its own layer)
 (This module seperates each letter in the string and imports it from Letters.dxf)
...
//	echo ("The word is ",(word)," if this is ç we know what to do"); 
//if (word[0] == "ç"){
//	echo ("the word split is ",(word[0])," ",(word[1])," hmm");
//	}
